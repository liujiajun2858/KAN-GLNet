...
# DATA_PATH = os.path.join(ROOT_DIR, 'data', 'stanford_indoor3d', 'Stanford3dDataset_v1.2_Aligned_Version')
g_classes = [x.rstrip() for x in open(os.path.join(BASE_DIR, 'meta/class_names.txt'), encoding='utf-8')]
g_class2label = {cls: i for i, cls in enumerate(g_classes)}
g_class2color = {'茎秆': [0, 255, 0],
                 '果荚': [0, 0, 255]}
