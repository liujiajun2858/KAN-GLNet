...
class ScannetDatasetWholeScene():
    ...
    def __init__(self, root, block_points=4096, split='test', test_area=5, stride=0.5, block_size=0.5, padding=0.001):
        ...
        labelweights = np.zeros(2) #原来13
        for seg in self.semantic_labels_list:
            tmp, _ = np.histogram(seg, range(3)) #原来14
